        ...
        <div class="container">
            <div class="header-registration-box">
                        ...
                        <div class="col-lg-7 co-12">
                            <div class="form-header-content d-flex align-items-center flex-lg-row flex-column">
                                ...
                                <div class="form-header-content-txt text-lg-left text-center">
                                    <h1 class="mb-0 form-header-content-txt-h1"><?php echo e($days[0]->{'name_' . $locale}); ?></h1>
                                    <p class="mb-0"><?php echo app('translator')->get('global.registration-page-header-subtitle'); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5 co-12">
                            <div class="form-header-countdown mt-lg-0 mt-4">
                                <div class="timer d-flex align-items-center justify-lg-content-end justify-content-center">
                                    <div  class="timer__clock d-flex justify-content-center align-items-center" title="<?php echo app('translator')->get('global.registration-page-clock-day'); ?>">
                                        <span id="days">90</span>
                                    </div>

                                    <div id="razd">:</div>

                                    <div  class="timer__clock d-flex justify-content-center align-items-center" title="<?php echo app('translator')->get('global.registration-page-clock-hour'); ?>">
                                        <span id="hours">90</span>
                                    </div>

                                    <div id="razd">:</div>

                                    <div  class="timer__clock d-flex justify-content-center align-items-center" title="<?php echo app('translator')->get('global.registration-page-clock-min'); ?>">
                                        <span id="minutes">90</span>
                                    </div>

                                    <div id="razd">:</div>

                                    <div  class="timer__clock d-flex justify-content-center align-items-center" title="<?php echo app('translator')->get('global.registration-page-clock-sec'); ?>">
                ...
                <div class="form-holder mt-4">
                    <form name="greencard-form" id="greencard-form" action="<?php echo e(route('siteRegistrationForm')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="form-holder-box-form">
                                        ...
                                        <div class="block-header"><?php echo app('translator')->get('global.registration-page-form-title-1'); ?></div>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-item">
                                                    <div class="form-group">
                                                        <label><?php echo app('translator')->get('global.registration-page-last_name'); ?></label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-item">
                                                    <div class="form-group">
                                                        <label><?php echo app('translator')->get('global.registration-page-first_name'); ?></label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-item">
                                                    <div class="form-group content__home__form">
                                                        <label for="exampleInputEmail1"><?php echo app('translator')->get('global.registration-page-gender'); ?></label>
                                                        <div class="gender d-flex">
                                                            <p>
                                                                <label>
                                                                <input name="gender" value="men" type="radio">
                                                                <span><img src="<?php echo e(asset('plugins_site/images/men.png')); ?>"> <?php echo app('translator')->get('global.registration-page-gender-men'); ?></span>
                                                                </label>
                                                            </p>
                                                            <p>
                                                                <label>
                                                                <input name="gender" value="women" type="radio">
                                                                <span><img src="<?php echo e(asset('plugins_site/images/women.png')); ?>"> <?php echo app('translator')->get('global.registration-page-gender-women'); ?></span>
                                                                </label>
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="validationCustom02"><?php echo app('translator')->get('global.registration-page-birthdate'); ?></label>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-birthdate-country'); ?></label>
                                                    <select onchange="getRegion('<?php echo e($regions); ?>', '<?php echo e($districts); ?>', 1, '<?php echo e($locale); ?>')"  id="country_id_1" name="country_id" class="form-control select2 js-example-placeholder-single"
                                                        ...
                                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>" class="text-uppercase"><?php echo e($item->{'name_' . $locale}); ?></option>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-birthdate-region'); ?></label>
                                                    <select onchange="getDistricts('<?php echo e($districts); ?>',1, '<?php echo e($locale); ?>')" id="region_id_1" name="region_id" class="form-control select2 js-example-placeholder-region dynamic" style="width: 100%;" value="">
                                                        <option></option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-birthdate-district'); ?></label>
                                        ...
                                        <div class="block-header"><?php echo app('translator')->get('global.registration-page-form-title-2'); ?></div>
                                        <div class="subheader"><?php echo app('translator')->get('global.registration-page-form-subtitle-2'); ?></div>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="exampleInputRounded0" class="" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page_numm-pass'); ?></label>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="exampleInputRounded0" class="" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page-pass-date'); ?></label>
                                            ...
                                            <div class="col-lg-4 col-12">
                                                <div class="form-group">
                                                    <label for="exampleInputRounded0" class="" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page-pass-addrs'); ?></label>
                                        ...
                                        <div class="block-header"><?php echo app('translator')->get('global.registration-page-form-title-3'); ?></div>
                                        <div class="subheader"><?php echo app('translator')->get('global.registration-page-form-subtitle-3'); ?></div>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="exampleInputRounded0" class="" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page-full_addr'); ?></label>
                                        ...
                                        <div class="subheader"><?php echo app('translator')->get('global.registration-page-form-subtitle-4'); ?></div>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="exampleInputRounded0" class="" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page-phone'); ?></label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="exampleInputRounded0" class="" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page-email'); ?></label>         
                                                    <input name="email" id="email" type="text" class="form-control" value="" placeholder="test@gmail.com">
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <div class="block-header"><?php echo app('translator')->get('global.registration-page-form-title-4'); ?></div>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-edu-level'); ?></label>
                                                    <select id="education_level" name="education_level" class="form-control select2 education-level"
                                                        ...
                                                        <?php $__currentLoopData = $education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->{'name_' . $locale}); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="block-header"><?php echo app('translator')->get('global.registration-page-form-title-5'); ?></div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-family-status'); ?></label>
                                                    <select id="family_status"  name="family_status" onchange="myFunction()" class="form-control select2 family-status" style="width: 100%;">
                                                        <option></option>
                                                        <option value="Unmarried"><?php echo app('translator')->get('global.registration-page-family-unmarried'); ?></option>
                                                        <option value="Married"><?php echo app('translator')->get('global.registration-page-family-married'); ?></option>
                                                        <option value="Divorced"><?php echo app('translator')->get('global.registration-page-family-divorced'); ?></option>
                                                        <option value="Widowed"><?php echo app('translator')->get('global.registration-page-family-widowed'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group" id="family_inform_div" style="display: none;">
                                                    <label for="exampleInputRounded0" class="" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page-family-spouse'); ?></label>
                                                    ...
                                                    <div class="row flex-column">
                                                        <div class="col-lg-7">
                                                            <div class="form-group childAddBox" id="child_inform_input">
                                                                <label for="exampleInputRounded0" style="font-size: 14px; color: #00214e!important; margin-bottom: 0 !important;font-weight: 700;"><?php echo app('translator')->get('global.registration-page-family-child'); ?></label>
                                                                <div class="input-relative position-relative">
                                                                    <input  id="child_inform" type="text" class="form-control text-uppercase" value="" placeholder="<?php echo app('translator')->get('global.registration-page-family-child-add'); ?>" disabled>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-holder-box-form-right">
                                        <div class="block-header"><?php echo app('translator')->get('global.registration-page-photo-requirements-title'); ?></div>
                                        <div class="avatar__image">
                                            <img id="image" src="<?php echo e(asset('plugins_site/images/photo.png')); ?>" alt="">
                                        </div>
                                        ...
                                        <label  class="btn avatar__button" for="primary__avatar">
                                            <img src="<?php echo e(asset('plugins_site/images/upload.png')); ?>">
                                            <?php echo app('translator')->get('global.registration-page-upload-photo'); ?>
                                        </label>
                                        <div class="content-txt">
                                            <p class="content-txt-info-title">
                                                <b style="color: #ef0000;"><?php echo app('translator')->get('global.registration-page-photo-requirements-rules-title'); ?> <br> <?php echo app('translator')->get('global.registration-page-photo-requirements-rules-txt'); ?></b>
                                            </p>
                                            <p class="content-txt-info"><?php echo app('translator')->get('global.registration-page-photo-requirements-rules-list1'); ?><br>
                                            <?php echo app('translator')->get('global.registration-page-photo-requirements-rules-list2'); ?><br>
                                            <?php echo app('translator')->get('global.registration-page-photo-requirements-rules-list3'); ?><br>
                                            <?php echo app('translator')->get('global.registration-page-photo-requirements-rules-list4'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="text-uppercase submit_btn"><?php echo app('translator')->get('global.registration-page-submit'); ?></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle"><?php echo app('translator')->get('global.registration-page-family-spouse-title'); ?></h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-birthdate-country'); ?></label>
                                                    <select onchange="getRegion('<?php echo e($regions); ?>','<?php echo e($districts); ?>',2, '<?php echo e($locale); ?>')"  id="country_id_2" name="country_id_secondry" class="form-control  select2 js-example-placeholder-single"
                                                        style="width: 100%;" value="">
                                                        <option></option>
                                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>" class="text-uppercase"><?php echo e($item->{'name_' . $locale}); ?></option>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-birthdate-region'); ?></label>
                                                    <select onchange="getDistricts('<?php echo e($districts); ?>',2, '<?php echo e($locale); ?>')" id="region_id_2" name="region_id_secondry" class="form-control select2 js-example-placeholder-region dynamic" style="width: 100%;" value="">
                                                        <option></option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="box-img">
                                                    <div class="avatar__image">
                                                        <img id="image_secondry" src="<?php echo e(asset('plugins_site/images/photo.png')); ?>" alt="">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('global.registration-page-form-title-4'); ?></label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" id="closeModelSecond" class="btn btn-secondary" data-dismiss="modal"><?php echo app('translator')->get('global.registration-page-modal-btn-close'); ?></button>
                                        <button type="button" onclick="submitForm()" id="submit" class="btn btn-primary"><?php echo app('translator')->get('global.registration-page-modal-btn-add'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            function add_input_field(count) {
                ...
                <div class="modal fade" id="exampleModalCenterChild_`+ currentNumber +`" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" data-backdrop="static" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle"><?php echo app('translator')->get('global.registration-page-child-modal-title'); ?></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                                ...
                                                <div class="gender-btns d-flex" id="left-column">
                                                    <div class="gender-btns-input button">
                                                        <span class="" id="child_male_`+ currentNumber +`" onclick="childGender(`+ currentNumber +`, 'male')" value="male">
                                                            <img src="<?php echo e(asset('plugins_site/images/men.png')); ?>"> <?php echo app('translator')->get('global.registration-page-gender-men'); ?>
                                                        </span>
                                                    </div>
                                                    
                                                    <div class="gender-btns-input button">
                                                        <span class="child_female" id="child_female_`+ currentNumber +`" onclick="childGender(`+ currentNumber +`, 'female')"  value="female">
                                                            <img src="<?php echo e(asset('plugins_site/images/women.png')); ?>"> <?php echo app('translator')->get('global.registration-page-gender-women'); ?>
                                                        </span>
                                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('global.registration-page-birthdate-country'); ?></label>
                                            <select onchange="getRegion('<?php echo e($regions); ?>','<?php echo e($districts); ?>',`+ currentNumber +`, '<?php echo e($locale); ?>')"  id="country_id_`+ currentNumber +`" name="country_id_secondry_child[]" class="form-control  select2 js-example-placeholder-single"
                                            style="width: 100%;" value="">
                                                <option></option>
                                                     <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>" class="text-uppercase"><?php echo e($item->{'name_' . $locale}); ?></option>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('global.registration-page-birthdate-region'); ?></label>
                                            <select onchange="getDistricts('<?php echo e($districts); ?>', `+ currentNumber +`, '<?php echo e($locale); ?>')" id="region_id_`+ currentNumber +`"name="region_id_secondry_child[]" class="form-control select2 js-example-placeholder-region dynamic" style="width: 100%;" value="">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="box-img">
                                            <div class="avatar__image">
                                                <img id="image_child_`+ currentNumber +`" src="<?php echo e(asset('plugins_site/images/avatar-child.jpg')); ?>" alt="">
                                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" id="closeModel" class="btn btn-secondary" data-dismiss="modal"><?php echo app('translator')->get('global.registration-page-modal-btn-close'); ?></button>
                                <button type="button" onclick="submitChildForm(`+ currentNumber +`)" id="submitChild" class="btn btn-primary"><?php echo app('translator')->get('global.registration-page-modal-btn-add'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\green-card\resources\views/pages/registration.blade.php ENDPATH**/ ?>