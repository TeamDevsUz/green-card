            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('visaIndex')); ?>">Управление виза</a></li>
            ...
            <div class="col-8 offset-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('visaUpdate', $day->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date timepicker" id="reservationdatethird" data-target-input="nearest">
                                    <input type="text" name="deadline" id="deadline" class="form-control datetimepicker-input" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask inputmode="numeric" data-target="#reservationdatethird" value="<?php echo e(old('date',$day->deadline)); ?>" readonly required>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <input type="text" name="name_uz" class="form-control" value="<?php echo e(old('name_uz', $day->name_uz)); ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <input type="text" name="name_ru" class="form-control" value="<?php echo e(old('name_ru', $day->name_ru)); ?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\green-card\resources\views/pages/visa/edit.blade.php ENDPATH**/ ?>