...
@section('content')
                        ...
                        <div class="row justify-content-center align-items-center text-center">
                            <div class="col-lg-8 col-12">
                                <div class="header_banner-content-txt-desc">
                                    <p class="mb-1">@lang('global.index-title-1')</p>
                                    <br>
                                    <p class="mb-4">@lang('global.index-title-2')</p>
                                </div>
                          </div>
                        </div>
                        <a href="{{route('siteForm')}}" class="header_banner-content-txt-btn d-flex justify-content-center align-items-center">@lang('global.fill_form')</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-12 mb-lg-0 mb-4">
                        <div class="header_banner-box-item d-flex justify-content-center align-items-center text-center">
                            ...
                            <p class="mb-2 medium-18 pt-3">@lang('global.index-boxs1-title')</p>
                            <p class="mb-0 regular-16">@lang('global.index-boxs1-txt')</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-lg-0 mb-4">
                        <div class="header_banner-box-item d-flex justify-content-center align-items-center text-center">
                            ...
                            <p class="mb-2 medium-18 pt-3">@lang('global.index-boxs2-title')</p>
                            <p class="mb-0 regular-16">@lang('global.index-boxs2-txt')</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="header_banner-box-item d-flex justify-content-center align-items-center text-center">
                            ...
                            <p class="mb-2 medium-18 pt-3">@lang('global.index-boxs3-title')</p>
                            <p class="mb-0 regular-16">@lang('global.index-boxs3-txt')</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <blockquote class="blockquote-primary">
                        <h2 class="main_faq-box-h2 text-left">@lang('global.green_card_title')</h2>
                        <div class="main__greenCard-mean-content">
                            <p>@lang('global.green_card_txt-1')</p>
                            <p>@lang('global.green_card_txt-2')</p>
                            <p>@lang('global.green_card_txt-3')</p>
                        </div>
                    </blockquote>
                    <a href="{{route('siteForm')}}" class="header_banner-content-txt-btn d-flex justify-content-center align-items-center">@lang('global.fill_form')</a>
                </div>
    ...
    <main class="main_news-box">
        <div class="container">
            <h2 class="main_faq-box-h2">@lang('global.news')</h2>
            <div class="row justify-content-center">
                <div class="col">
                ...
                <div class="col-lg-8">
                    <div class="main_greenCard-box-item text-center">
                        <h2 class="main_greenCard-box-item-h2">
                            @lang('global.index-greencardBox-title')
                            <br>
                            @lang('global.index-greencardBox-subtitle')
                        </h2>
                        <a href="{{route('siteForm')}}" class="header_banner-content-txt-btn d-flex justify-content-center align-items-center">@lang('global.fill_form')</a>
                    </div>
                </div>
    ...
    <main class="main_faq-box paddingClass-100">
        <div class="container">
            <h2 class="main_faq-box-h2">@lang('global.index-lastBox-title')</h2>
            <div class="toggle toggle-primary m-0" data-plugin-toggle="">
                <section class="toggle">
                    <a class="toggle-title">@lang('global.index-lastBox-q1')</a>
                    <div class="toggle-content" style="display: none;">
                        <p>@lang('global.index-lastBox-ans1')</p>
                    </div>
                </section>

                <section class="toggle">
                    <a class="toggle-title">@lang('global.index-lastBox-q2')</a>
                    <div class="toggle-content">
                        <p>@lang('global.index-lastBox-ans2')</p>
                    </div>
                </section>

                <section class="toggle">
                    <a class="toggle-title">@lang('global.index-lastBox-q3')</a>
                    <div class="toggle-content">
                        <p>@lang('global.index-lastBox-ans3')</p>
                    </div>
                </section>

                <section class="toggle">
                    <a class="toggle-title">@lang('global.index-lastBox-q4')</a>
                    <div class="toggle-content">
                        <p>@lang('global.index-lastBox-ans4')</p>
                    </div>
                </section>

                <section class="toggle">
                    <a class="toggle-title">@lang('global.index-lastBox-q5')</a>
                    <div class="toggle-content">
                        <p>@lang('global.index-lastBox-ans5')</p>
                    </div>
                </section>
            </div>
        </div>
