...
<nav class="mt-2">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @can('registration.view')
            <li class="nav-item">
                <a href="{{ route('orderIndex') }}" class="nav-link {{ Request::is('registration*') ? "active":'' }}">
                    <i class="fas fa-user-check"></i>
                    <p> @lang('cruds.registration.title')</p>
                </a>
            </li>
        @endcan
        @can('visa.view')
            <li class="nav-item">
                <a href="{{ route('visaIndex') }}" class="nav-link {{ Request::is('visa*') ? "active":'' }}">
                    <i class="fas fa-calendar-alt"></i>
                    <p> @lang('cruds.visa.title')</p>
                </a>
            </li>
        @endcan
    </ul>
